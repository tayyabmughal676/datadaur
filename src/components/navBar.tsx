                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="hidden md:flex items-center">
                                <button
                                    ...
                                    className="bg-gradient-to-r from-[#604CC3] to-[#2E245D] text-white px-6 py-2.5 rounded-xl font-outfit font-medium text-sm hover:shadow-lg transition-all duration-200 transform hover:scale-105"
                                >
                                    Contact Us
                                </button>
                            </div>
