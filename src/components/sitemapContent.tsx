    ...
    const sitemapData = [
        ...
        },
        {
            ...
            pages: [
                ...
                { name: "Terms & Conditions", path: "/terms-and-conditions", description: "Our service terms and conditions" }
            ]
        }
    ];
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-10 lg:px-12 py-16 sm:py-20">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                    {stats.map((stat, index) => (
                        <div key={index} className="group relative">
                            <div className="text-center p-6 bg-gradient-to-br from-[#604CC3]/5 to-[#2E245D]/5 rounded-2xl border border-[#604CC3]/10 hover:border-[#604CC3]/20 transition-all duration-300 hover:shadow-lg hover:shadow-[#604CC3]/10 hover:-translate-y-1">
                                ...
                                <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-[#604CC3] to-[#2E245D] bg-clip-text text-transparent mb-2">
                                    {stat.value}
                                </div>
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-[#604CC3]/80 max-w-3xl mx-auto leading-relaxed">
                        Navigate through our comprehensive collection of pages, each designed to showcase our expertise and help you discover the perfect solution for your needs.
                    </p>
                </div>
                    ...
                    {sitemapData.map((category, categoryIndex) => (
                        <div key={categoryIndex} className="relative">
                            ...
                            <div className="flex items-start gap-6 mb-8">
                                <div className="flex-shrink-0 flex items-center justify-center w-16 h-16 bg-gradient-to-r from-[#604CC3] to-[#2E245D] rounded-2xl text-white shadow-lg">
                                    {category.icon}
                                </div>
                                    ...
                                    <div key={pageIndex} className="group relative">
                                        ...
                                        >
                                            <div className="flex items-start justify-between mb-4">
                                                ...
                                                <ExternalLink className="w-5 h-5 text-[#604CC3]/60 group-hover:text-[#604CC3] group-hover:scale-110 transition-all duration-300" />
                                            </div>
                                            ...
                                            <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-[#604CC3] to-[#2E245D] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 rounded-b-2xl"></div>
                                        </a>
                                    </div>
                                ))}
                            </div>
                ...
                {/* Quick Navigation */}
                <div className="mt-20 p-8 bg-gradient-to-br from-[#604CC3]/5 to-[#2E245D]/5 rounded-3xl border border-[#604CC3]/10">
                ...
                <div className="mt-20 text-center">
                    <div className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#604CC3] to-[#2E245D] text-white rounded-2xl font-medium hover:shadow-lg hover:shadow-[#604CC3]/25 transition-all duration-300 hover:-translate-y-1 cursor-pointer">
                    ...
                    <div className="mt-6 space-y-2">
                        <p className="text-[#604CC3]/80 text-lg">
                            Contact us at{' '}
                            <a href="mailto:contact@datadaur.com" className="text-[#604CC3] hover:text-[#2E245D] font-medium hover:underline transition-colors duration-300">
